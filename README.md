...
The supporting Macros are all contained within SimpleCorm.h, with SimpleCorm* within the test_source directory provided to test the functionality and show examples of usage.
